...
public class ExceptAddressKeywordVO {
	...
	public ExceptAddressKeywordVO(int eakPk, String eakWord, boolean eakFlag, String eakRegdate) {
		super();
		this.eakPk = eakPk;
	...
	public String toString() {
		return "ExceptAddressKeywordVO [eakPk=" + eakPk + ", eakWord=" + eakWord + ", eakFlag=" + eakFlag
				+ ", eakRegdate=" + eakRegdate + "]";
	}
