<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#orderDeleteSearchBtn").click(function(){
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				            ...
				            <div class="card-body">
				            	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
			                    	<input type="text" class="btn btn-light btn-xs mb-2" id="dateStart" style="width: 8em;" value="${osVO.dateStart }"/> &nbsp;
						            <input type="text" class="btn btn-light btn-xs mb-2" id="dateEnd" style="width: 8em;" value="${osVO.dateEnd }"/>
						            <button class="btn btn-primary btn-xs mb-2" type="button" id="orderDeleteSearchBtn"> 검색 </button>
			                    </div>
				        		<table class="table table-hover">
				                    ...
				                    <tbody>
				                        ...
				                        <c:if test="${empty orderDeleteList }">
				                        	<tr>
				                        		<td colspan="9" style="text-align: center;">작업기록이 없습니다</td>
				                        	</tr>
				                        </c:if>
				                   	</tbody>
				                </table>
						...
						<form class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" id="orderDeleteSearchForm" action="<c:url value='/order/config/delete_order_list.do'/>" method="get">
                        	<input type="hidden" name="dateStart" value="${osVO.dateStart }">
                        	<input type="hidden" name="dateEnd" value="${osVO.dateEnd }">
